-- Create database
CREATE DATABASE IF NOT EXISTS marc_school;
USE marc_school;
...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('system_admin', 'school_admin', 'students') NOT NULL,
...
VALUES ('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@marcagape.edu', 'System', 'Administrator', 'system_admin');

-- Insert some default payment categories
